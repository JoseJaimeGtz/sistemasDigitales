...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Morse/Morse.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source morse_encoder.tcl
