...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos de Sistemas Digitales/Practica 3/sistemasDigitales/Cronometro/Cronometro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conometro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conometro.tcl
