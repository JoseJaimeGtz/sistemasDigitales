...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos de Sistemas Digitales/sistemasDigitales/uartRX/uartRX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uartRXBasys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uartRXBasys3.tcl -notrace
