...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos de Sistemas Digitales/sistemasDigitales/Morse Final/morse_code_encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uartRXBasys3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uartRXBasys3.tcl
